package com.zhulin.gulimall.coupon.controller;
...
import com.zhulin.gulimall.coupon.service.CouponHistoryService;
...
public class CouponHistoryController {
    ...
    private Logger logger = LoggerFactory.getLogger("CouponHistoryController");
    ...
    public R list(@RequestParam Map<String, Object> params){
        ...
        logger.debug("nacos config=====" + testNacosConfig);
